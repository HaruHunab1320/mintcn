...
export function ConnectProject({ open, onClose, onLoaded, onResetToFixture }: ConnectProjectProps) {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      ariaLabel="Connect project"
      backdropClassName="bg-background/70"
      surfaceClassName="flex w-full max-w-lg flex-col gap-3 rounded-lg border border-border bg-background p-5 text-foreground shadow-2xl"
    >
