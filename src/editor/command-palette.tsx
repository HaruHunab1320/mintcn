...
export function CommandPalette({ commands, open, onClose }: CommandPaletteProps) {
  ...
  // Arrow navigation + Enter to invoke. Escape is handled by Modal at the
  // document level, so we don't need to duplicate it here.
  ...
  return (
    <Modal
      ...
      surfaceClassName="flex max-h-[70vh] w-full max-w-xl flex-col overflow-hidden rounded-lg border border-border bg-background text-foreground shadow-2xl"
    >
      <input
        ref={inputRef}
        type="text"
