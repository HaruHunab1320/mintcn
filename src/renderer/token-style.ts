...
export type MintcnTheme = 'light' | 'dark';
 ...
 *     (headers, panels, borders) responds to token edits too — i.e. Mintcn
 *     itself is a live preview.
 *
 * Emit and preview read the same source of truth, so what you see is what
 * you'll export.
 */
export function tokensToCssVars(doc: ProjectDocument, theme: MintcnTheme): CSSProperties {
