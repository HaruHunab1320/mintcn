...
const STYLE_ELEMENT_ID = 'tincture-force-state-styles';
...
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="default"],
.tincture-preview[data-force-state="hover"] [data-slot="badge"][data-variant="default"] {
  background-color: color-mix(in oklab, var(--primary), transparent calc((1 - var(--hover-opacity, 0.9)) * 100%));
}
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="destructive"],
.tincture-preview[data-force-state="hover"] [data-slot="badge"][data-variant="destructive"] {
  background-color: color-mix(in oklab, var(--destructive), transparent calc((1 - var(--hover-opacity, 0.9)) * 100%));
}
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="secondary"],
.tincture-preview[data-force-state="hover"] [data-slot="badge"][data-variant="secondary"] {
  background-color: color-mix(in oklab, var(--secondary), transparent calc((1 - var(--hover-opacity, 0.9)) * 100%));
}
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="outline"],
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="ghost"] {
  background-color: var(--accent);
  color: var(--accent-foreground);
}
.tincture-preview[data-force-state="hover"] [data-slot="button"][data-variant="link"] {
  text-decoration: underline;
}

.tincture-preview[data-force-state="focus-visible"] [data-slot="button"],
.tincture-preview[data-force-state="focus-visible"] [data-slot="input"],
.tincture-preview[data-force-state="focus-visible"] [data-slot="textarea"],
.tincture-preview[data-force-state="focus-visible"] [data-slot="select-trigger"] {
  outline: none;
...
.tincture-preview[data-force-state="active"] [data-slot="button"] {
  transform: scale(var(--active-scale, 0.97));
}

.tincture-preview[data-force-state="disabled"] [data-slot="button"],
.tincture-preview[data-force-state="disabled"] [data-slot="badge"],
.tincture-preview[data-force-state="disabled"] [data-slot="input"],
.tincture-preview[data-force-state="disabled"] [data-slot="textarea"],
.tincture-preview[data-force-state="disabled"] [data-slot="select-trigger"],
.tincture-preview[data-force-state="disabled"] [data-slot="checkbox"],
.tincture-preview[data-force-state="disabled"] [data-slot="switch"] {
