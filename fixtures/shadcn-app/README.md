...
A snapshot of a real shadcn-init output (style: `new-york`, base color: `slate`, Tailwind v4, RSC off, TSX on) used as the round-trip test target for Mintcn's ingest and codegen pipelines.
